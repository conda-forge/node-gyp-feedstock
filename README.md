...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/node-gyp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/node-gyp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12223&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/node-gyp-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_nodejs26" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
It is possible to list all of the versions of `node-gyp` available on your platform:
...
```
pixi search node-gyp --channel conda-forge
```
